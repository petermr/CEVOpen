 ...
 * @author Clyde Davies
 */
public class CEVTaggerNodeNodePlugin extends Plugin {
    // The shared instance.
    private static CEVTaggerNodeNodePlugin plugin;

    /**
     * The constructor.
     */
    public CEVTaggerNodeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CEVTaggerNodeNodePlugin getDefault() {
        return plugin;
    }
